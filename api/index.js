...
// app.post("/api/v1/register", async (_req, res) => {
...
import registers from "./routers/registers.js";
...
app.listen(PORT, () => console.log(`Server berhasil dijalankan. https: //localhost:${PORT}`));
